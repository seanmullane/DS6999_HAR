...
ct = 0
for name in files[:1]: # Remove the limiter [:1] before the final
    ct += 1
    print(ct, "/", 8, name)
    ...
    for seconds in [1,2,3,5]:
        no_obs = seconds*hz
        group = df.groupby(df.index//(no_obs) * (no_obs))
        print(name)
        print(seconds)
        print('noobs',no_obs)
        break # Remove this as well
    
    df_out = df
    
    # tBodyAcc-Mean-1
    df_out['tBodyAcc-Mean-1'] = group['tAcc-X'].mean()
    # tBodyAcc-Mean-2                
    df_out['tBodyAcc-Mean-2'] = group['tAcc-Y'].mean()
    # tBodyAcc-Mean-3                
    df_out['tBodyAcc-Mean-3'] = group['tAcc-Z'].mean()
    # tBodyAcc-STD-1                 
    df_out['tBodyAcc-STD-1'] = group['tAcc-X'].std()
    # tBodyAcc-STD-2                 
    df_out['tBodyAcc-STD-2'] = group['tAcc-Y'].std() 
    # tBodyAcc-STD-3                 
    df_out['tBodyAcc-STD-3'] = group['tAcc-Z'].std()            
    # tBodyAcc-Mad-1
    df_out['tBodyAcc-Mad-1'] = group['tAcc-X'].mad()
    # tBodyAcc-Mad-2                 
    df_out['tBodyAcc-Mad-2'] = group['tAcc-Y'].mad()
    # tBodyAcc-Mad-3                 
    df_out['tBodyAcc-Mad-3'] = group['tAcc-Z'].mad()
    # tBodyAcc-Max-1
    df_out['tBodyAcc-Max-1'] = group['tAcc-X'].max()               
    # tBodyAcc-Max-2                 
    df_out['tBodyAcc-Max-2'] = group['tAcc-Y'].max()       
    # tBodyAcc-Max-3                 
    df_out['tBodyAcc-Max-3'] = group['tAcc-Z'].max()    
    # tBodyAcc-Min-1                 
    df_out['tBodyAcc-Min-1'] = group['tAcc-X'].min()  
    # tBodyAcc-Min-2                 
    df_out['tBodyAcc-Min-2'] = group['tAcc-Y'].min()    
    # tBodyAcc-Min-3                 
    df_out['tBodyAcc-Min-3'] = group['tAcc-Z'].min() 
    # tBodyAcc-SMA-1
